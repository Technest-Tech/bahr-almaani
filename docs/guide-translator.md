...
ما دام مدير المشروع لم يفتح المراجعة، يظهر تسليمك في البورتال تحت **بانتظار المراجعة**:

- **استبدال** بجوار أي ملف: اختر الملف الصحيح فيحلّ محل القديم.
- **حذف**: لملف أُرسل بالخطأ ضمن عدة ملفات. آخر ملف في التسليم لا يُحذف — استبدله.
- **إضافة ملف نسيته**: ينضم إلى التسليم نفسه.

يصل مدير المشروع إشعار بكل تعديل، ولا تتغير مدة عملك. بمجرد أن يفتح المراجعة يُقفل
التسليم، وأي تصحيح بعدها يكون بطلب تعديل منه.
