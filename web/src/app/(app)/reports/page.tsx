...
const REPORT_NOTES: Partial<Record<ReportType, string>> = {
  translators:
    "الصفحات والكلمات تُحسب من الملفات التي سلّمها المترجم — والصفحات من النسخة النهائية المعتمدة عند توفرها. إن لم يكتمل عدّ التسليم بعد، يظهر عدّ ملفات المصدر مؤقتًا.",
  pms:
    "«الصفحات المُترجمة» هي صفحات التسليمات الفعلية للمشاريع التي أنشأها هذا المدير ووصلت لمرحلة التسليم.",
  monthly:
    "الصفحات والكلمات تُحسب من ملفات الترجمة المُسلَّمة، لا من ملفات المصدر.",
  productivity:
